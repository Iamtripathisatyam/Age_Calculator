...
while valid:
 ...
 try:
    ...
    notification.notify(title="Age Calculator Presented by : @Satyam Tripathi & Company ",
 ...
 if in_date<=date:
   ...
   notification.notify(title="Age Calculator Presented by : @Satyam Tripathi & Company ", message=f"\n\tYour Age : {relativedelta(datetime.now(),now).years} Years, "
